...
Generated: 2026-07-17 21:54:18 -0400
...
```json
{
  ...
  "truncate": {
    ...
    "fts_only": {
      ...
      "miss_rate@1": 0.2,
      "miss_samples": [
        "decision: ollama embed uses truncate=false so oversize chunks fail lou"
      ]
    },
    "hybrid": {
      "n": 5,
